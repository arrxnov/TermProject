...
CREATE TABLE catalog_course (
    ...
    CONSTRAINT catalog_course_pk PRIMARY KEY (course_id,catalog_year)
);
...
-- Table: planned_concentration
CREATE TABLE planned_concentration (
    concentration_id int  NOT NULL,
    plan_id int  NOT NULL,
    CONSTRAINT planned_concentration_pk PRIMARY KEY (concentration_id,plan_id)
);
...
CREATE TABLE planned_course (
    ...
    CONSTRAINT planned_course_pk PRIMARY KEY (plan_id,course_id,year,term)
);
...
CREATE TABLE planned_major (
    major_id int  NOT NULL,
    plan_id int  NOT NULL,
    CONSTRAINT planned_major_pk PRIMARY KEY (major_id,plan_id)
);
...
CREATE TABLE planned_minor (
    minor_id int  NOT NULL,
    plan_id int  NOT NULL,
    CONSTRAINT planned_minor_pk PRIMARY KEY (minor_id,plan_id)
);
...
-- foreign keys
-- Reference: catalog_catalog (table: catalog_course)
ALTER TABLE catalog_course ADD CONSTRAINT catalog_catalog FOREIGN KEY catalog_catalog (catalog_year)
    REFERENCES catalog (year);

-- Reference: catalog_course (table: catalog_course)
ALTER TABLE catalog_course ADD CONSTRAINT catalog_course FOREIGN KEY catalog_course (course_id)
...
-- Reference: planned_concentration_concentration (table: planned_concentration)
ALTER TABLE planned_concentration ADD CONSTRAINT planned_concentration_concentration FOREIGN KEY planned_concentration_concentration (concentration_id)
    REFERENCES concentration (id);

-- Reference: planned_concentration_plan (table: planned_concentration)
ALTER TABLE planned_concentration ADD CONSTRAINT planned_concentration_plan FOREIGN KEY planned_concentration_plan (plan_id)
    REFERENCES plan (id);

-- Reference: planned_courses_course (table: planned_course)
ALTER TABLE planned_course ADD CONSTRAINT planned_courses_course FOREIGN KEY planned_courses_course (course_id)
    REFERENCES course (id);

-- Reference: planned_courses_plan (table: planned_course)
ALTER TABLE planned_course ADD CONSTRAINT planned_courses_plan FOREIGN KEY planned_courses_plan (plan_id)
    REFERENCES plan (id);

-- Reference: planned_major_major (table: planned_major)
ALTER TABLE planned_major ADD CONSTRAINT planned_major_major FOREIGN KEY planned_major_major (major_id)
    REFERENCES major (id);

-- Reference: planned_major_plan (table: planned_major)
ALTER TABLE planned_major ADD CONSTRAINT planned_major_plan FOREIGN KEY planned_major_plan (plan_id)
    REFERENCES plan (id);

-- Reference: planned_minor_minor (table: planned_minor)
ALTER TABLE planned_minor ADD CONSTRAINT planned_minor_minor FOREIGN KEY planned_minor_minor (minor_id)
    REFERENCES minor (id);

-- Reference: planned_minor_plan (table: planned_minor)
ALTER TABLE planned_minor ADD CONSTRAINT planned_minor_plan FOREIGN KEY planned_minor_plan (plan_id)
    REFERENCES plan (id);

-- Reference: prereqs_course1 (table: prereq)
ALTER TABLE prereq ADD CONSTRAINT prereqs_course1 FOREIGN KEY prereqs_course1 (course_id)
    REFERENCES course (id);

-- Reference: prereqs_course2 (table: prereq)
ALTER TABLE prereq ADD CONSTRAINT prereqs_course2 FOREIGN KEY prereqs_course2 (prereq_id)
    REFERENCES course (id);
