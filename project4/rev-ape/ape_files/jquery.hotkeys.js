/*
 * zck 9/29/11
 * Note to APE: pulled from https://github.com/ricardovaleriano/jquery.hotkeys/blob/master/jquery.hotkeys.js
 *	I use it to detect CTRL+S, which can actually be surprisingly tricky cross-browsrer+OS
 *
 *
