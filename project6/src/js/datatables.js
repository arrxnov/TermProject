 ...
 *   https://datatables.net/download/#dt/dt-2.0.0/sc-2.4.0/sb-1.7.0/sp-2.3.0/sl-2.0.0
 *
 * Included libraries:
 *   DataTables 2.0.0, Scroller 2.4.0, SearchBuilder 1.7.0, SearchPanes 2.3.0, Select 2.0.0
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-2.0.0/sc-2.4.0/sb-1.7.0/sp-2.3.0/sl-2.0.0",
